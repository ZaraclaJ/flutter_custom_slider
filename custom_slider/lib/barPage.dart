            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Bar(
                    ...
                    70.0,
                    [
                      CellData(Color(0xFF881B24), "-3", rightGap: 0.3),
                      CellData(Color(0xFFD2531C), "-2", rightGap: 0.3),
                      CellData(Color(0xFFF19E13), "-1", rightGap: 0.3),
                      CellData(Color(0xFF000000), "0", rightGap: 0.3),
                    ],
                    Colors.white,
                    5.0),
              ),
